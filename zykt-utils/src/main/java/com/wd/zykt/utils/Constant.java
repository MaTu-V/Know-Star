...
public class Constant {
    ...
    public static class RedisCode {
        ...
        // 网站内容
        public static final String WEBSITE_REDIS_SESSION = "website_redis_session";
        // 滚动条
        public static final String SERIES_REDIS_SESSION = "series_redis_session";
        // 分类滑动条
        public static final String CATEGORY_REDIS_SESSION = "category_redis_session";
        // 分类全部信息
        public static final String CATEGORY_ALL_REDIS_SESSION = "category_all_redis_session";
        // 书籍科目分类
        public static final String CLASSIFY_REDIS_SESSION = "classify_redis_session";
        // 用户信息
        public static final String USER_REDIS_SESSION = "user_redis_session";
        // 全部用户信息
        public static final String USER_ALL_REDIS_SESSION = "user_all_redis_session";
        // 书籍信息
        public static final String BOOK_REDIS_SESSION = "book_redis_session";
        // 快搜历史记录
        public static final String HOTWORD_REDIS_SESSION =  "hotWord_redis_session";
    }
    ...
    public static class PageHelper {
        ...
        // 能量豆
        public static final Integer ENERGY_SIZE = 2;
    }
}